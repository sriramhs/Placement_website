        ...
        <nav style="background-color:lightskyblue;">
                       <img src="NMITlogo.PNG" width="100" height="80">
                        <ul>
                            ...
                            <!-- <li><a href="studenttraining.php">View Training</a></li> -->
                            <li><a href="RegisterCompany.php">Register</a></li>
...
<section style="background-color:lightblue;">
  ...
  <div class="container">
    ...
    <a href="compdetails.php"><button style="width:100%;padding:19px 40px;font-size:20px;background-color:lightcyan;">Company Details</button></a>
  </div>
</div></td>
<td>
<div class="card" style="width:350px;height:300px;">
<img src="training.png" alt="Avatar"  style="width:350px;height:230px;">
  <div class="container">
    ...
    <a href="studenttraning.php"><button style="width:100%;padding:19px 40px;font-size:20px;background-color:lightcyan;">View Training</button></a>
  </div>
</div>
</td>
